...
import lins.aaa.ui.fragment.HotFragment;
import lins.aaa.ui.fragment.MeFragment;
import lins.aaa.widget.FragmentTabHostEx;
...
//    private String atadrs = App.getSharedData(Config.AT_ADDRESS);
    ...
    protected void initView() {
        ...
        binding.toolbar.tvTopTitle.setText("首页");
//        binding.toolbar.ivTopRight.setImageResource(R.drawable.add);
...
//        ServiceUtil.stopServiceUtil(MainActivity.this);
    ...
    private void setupViewPager(ViewPager mViewPager) {
        ...
        adapter.addFragment(new HomeFragment(),"广场");
        adapter.addFragment(new HomeFragment(),"广场");
        adapter.addFragment(new MeFragment(),"广场");
...
//    }
    ...
    public enum MainTab {
        ...
        MAIN_TAB(0, HomeFragment.TAG, R.string.app_name,R.drawable.add,
                HomeFragment.class),

        HOT(1, "ChatListFragment", R.string.app_name, R.drawable.add,
                HotFragment.class),

//        START(2, "none",  R.string.app_name,R.drawable.circle,
//                null),

        MINE(2, "MeFragment",R.string.app_name, R.drawable.add,
                MeFragment.class);
//
